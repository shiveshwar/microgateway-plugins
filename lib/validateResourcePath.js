...
var url = require('url');
var debug = require('debug')('validateresourcepath');
const DOUBLE_STAR_PLACEHOLDER = '@@@@';
const SUPPORTED_SINGLE_FORWARD_SLASH_PATTERN = "/";

module.exports = function(logger, componentName, customDebug) {
    if(customDebug){
        debug = customDebug; 
    }
    return function (config, req, res, decodedToken, productOnly) {
